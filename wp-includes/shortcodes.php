...
$params = shortcode_atts(array(
    'item' => '4isbjanWnf0.png',
    'item2' => 'image17.png',
    'item3' => 'Photoface2@1X.png',
),$atts);

    foreach ( $params as  $param) {
        $res .= '<img class="short_img" src="http://wordpress.local/wp-content/themes/Free_people/img/' . $param . '"/>';
    }
    return "<div class='bxslider'>$res </div>";
                 
}
add_shortcode( 'short', 'my_func' );
