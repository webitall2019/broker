...
function bazz_layout() { ?>
    ...
    <div class="bazz-widget">
        <div class="bazz-widget-button">
            <i></i>
            <i><div><?php _e( 'Звонок', 'bazz-callback-widget' ); ?></div></i>
        </div>
        ...
        <div class="bazz-widget-form">
            <div class="bazz-widget-form-top">
                <label>
                    ...
                    <?php $you_hyperlink =  '<a href="javascript:void(0);" class="bazz-widget-your-name">' . esc_html__( 'Вам', 'bazz-callback-widget' ) . '</a>'; ?>
					...
					<?php } else { ?>
						...
						<?php echo( sprintf( esc_html__( 'Звонок через %s %s секунд!', 'bazz-callback-widget' ), $you_hyperlink, $time_option ) ); ?>
                ...
                <input id="bazz-widget-phone" name="bazz-widget-phone" value="" type="tel"
                       placeholder="<?php _e( 'телефон', 'bazz-callback-widget' ); ?>"/>
                <a href="javascript:void(0);"
                   class="bazz-widget-form-submit"><?php _e( 'позвонить мне!', 'bazz-callback-widget' ); ?></a>
                <div class="bazz-widget-form-info"></div>
            </div>
            <div class="bazz-widget-form-bottom">
                <label><?php _e( "Представтесь пожалуйста, и мы Вам перезвоним", 'bazz-callback-widget' ); ?></label>
                <input id="bazz-widget-name" class="grey-placeholder" name="bazz-widget-name" value="" type="text"
                       placeholder="<?php _e( 'имя', 'bazz-callback-widget' ); ?>"/>
