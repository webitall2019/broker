...
class cg_primary_menu extends Walker_Nav_Menu {
...
add_filter( 'wp_nav_menu_objects', 'cg_add_menu_parent_class' );

function cg_add_menu_parent_class( $items ) {
...
class cg_mobile_menu extends Walker_Nav_Menu {
