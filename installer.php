...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'broker_child_dublicator_f7a082a074b5b6293998_20191222191210_archive.zip';
	const ARCHIVE_SIZE		 = '326832940';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f7a082a-22191210';
